...
export class GravatarRegistry__getGravatarResult {
  value0: string;
  value1: string;
...
export class GravatarRegistry__gravatarsResult {
  value0: Address;
  value1: string;
  value2: string;
...
export class GravatarRegistry extends ethereum.SmartContract {
  static bind(address: Address): GravatarRegistry {
    return new GravatarRegistry("GravatarRegistry", address);
  }

  getGravatar(owner: Address): GravatarRegistry__getGravatarResult {
    ...
    return new GravatarRegistry__getGravatarResult(
      result[0].toString(),
      result[1].toString()
    );
  }
  ...
  try_getGravatar(
    owner: Address
  ): ethereum.CallResult<GravatarRegistry__getGravatarResult> {
    ...
    return ethereum.CallResult.fromValue(
      new GravatarRegistry__getGravatarResult(
        value[0].toString(),
        value[1].toString()
      )
    );
  ...
  gravatars(param0: BigInt): GravatarRegistry__gravatarsResult {
    let result = super.call(
      "gravatars",
    ...
    return new GravatarRegistry__gravatarsResult(
      result[0].toAddress(),
      result[1].toString(),
      result[2].toString()
    );
  ...
  try_gravatars(
    param0: BigInt
  ): ethereum.CallResult<GravatarRegistry__gravatarsResult> {
    let result = super.tryCall(
      "gravatars",
      "gravatars(uint256):(address,string,string)",
      [ethereum.Value.fromUnsignedBigInt(param0)]
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new GravatarRegistry__gravatarsResult(
        value[0].toAddress(),
        value[1].toString(),
        value[2].toString()
      )
