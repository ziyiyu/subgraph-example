...
contract GravatarRegistry {
  event NewGravatar(string groupName,uint id, address owner, string displayName, string imageUrl);
  event UpdatedGravatar(string groupName,uint id, address owner, string displayName, string imageUrl);
  ...
  function createGravatar(string calldata _displayName, string calldata _imageUrl) public {
    ...
    emit NewGravatar(groupName,id, msg.sender, _displayName, _imageUrl);
  }
  ...
  function updateGravatarName(string calldata _displayName) public {
    ...
    emit UpdatedGravatar(groupName,id, msg.sender, _displayName, gravatars[id].imageUrl);
  }
  ...
  function updateGravatarImage(string calldata _imageUrl) public {
    ...
    emit UpdatedGravatar(groupName,id, msg.sender, gravatars[id].displayName, _imageUrl);
  }
